...
@McpTool(
        ...
        description = "Get information about the metatron system including router state, server information, and system statistics.",
        category = "system"
)
public class AnnotatedGetSystemInfoTool {

    private static final GraphittyLogger LOG = Graphitty.log(AnnotatedGetSystemInfoTool.class);
