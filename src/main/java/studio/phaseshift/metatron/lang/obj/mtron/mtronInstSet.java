...
public class mtronInstSet extends MInstSet {
    ...
    protected void load() {
        ...
        this.write(
                ...
                IN_TID, instC(IN_TID.dom(fURI.ANY.maybe()).rng(BOOL_TID), lst(T(fURI.ANY.maybe())), (lhs, inst) -> bool(lhs.matches(inst.arg(0)))),
                ...
                COUNT_TID, instC(COUNT_TID.dom(ANY_TID.any()).rng(INT_TID), NO_ARGS__, (lhs, inst) -> IteratorUtil.reduce(lhs.iterator(), jnt(0), (a, b) -> MInst.instB(PLUS_TID, lst(jnt(1))).apply(a))),
