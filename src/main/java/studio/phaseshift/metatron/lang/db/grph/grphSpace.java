...
public class grphSpace extends MSpace<Space> {
    ...
    protected static final Type GRPH_TYPE = T(GRPH_TID, null, instC(mtronInstSet.INST_TID.dom(ALL.maybe()).rng(GRPH_TID), lst(T(REC_TID, isa_(rec(uri(PATTERN), T(URI_TID), uri("load"), T(URI_TID.maybe()), uri("space"), T(ALL))))), (lhs, inst) -> {
