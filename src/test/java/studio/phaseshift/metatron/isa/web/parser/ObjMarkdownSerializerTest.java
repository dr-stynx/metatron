...
public class ObjMarkdownSerializerTest extends AbstractSerializerTest<Node> {
    ...
    public void testSimpleParagraphWithFormatting() {
        ...
        final Obj bodyChildren = body.asRec().at(uri(CHILDREN));
        Obj p = null;
        ...
        final Obj pChildren = p.asRec().at(uri(CHILDREN));
    ...
    public void testMarkdownToHTMLConversion() {
        ...
        final Obj pChildren = paragraphWithFormatting.asRec().at(uri(CHILDREN));
        ...
        final Obj ulChildren = ul.asRec().at(uri(CHILDREN));
